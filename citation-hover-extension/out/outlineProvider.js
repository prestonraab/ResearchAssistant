...
exports.OutlineTreeItem = exports.OutlineTreeProvider = void 0;
const vscode = __importStar(require("vscode"));
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
class OutlineTreeProvider {
    constructor() {
    ...
    async linkClaimsToSections(workspaceUri) {
        const config = vscode.workspace.getConfiguration('citationHover');
    ...
    calculateRelevance(claimTitle, section) {
        let score = 0;
    ...
    createSectionItem(section) {
        ...
        const item = new OutlineTreeItem(section.title, hasChildren ? vscode.TreeItemCollapsibleState.Collapsed : vscode.TreeItemCollapsibleState.None);
    ...
    getSectionChildren(sectionId) {
        ...
        if (section.questions.length > 0) {
            const questionsItem = new OutlineTreeItem(`❓ Questions (${section.questions.length})`, vscode.TreeItemCollapsibleState.Collapsed);
        ...
        if (section.linkedClaims.length > 0) {
            const claimsItem = new OutlineTreeItem(`📝 Linked Claims (${section.linkedClaims.length})`, vscode.TreeItemCollapsibleState.Collapsed);
        ...
        if (section.suggestedSearches.length > 0) {
            const searchesItem = new OutlineTreeItem(`🔍 Suggested Searches (${section.suggestedSearches.length})`, vscode.TreeItemCollapsibleState.Collapsed);
...
exports.OutlineTreeProvider = OutlineTreeProvider;
class OutlineTreeItem extends vscode.TreeItem {
    constructor(label, collapsibleState, sectionId) {
...
exports.OutlineTreeItem = OutlineTreeItem;
