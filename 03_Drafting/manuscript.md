...
> Figure 2 displays results for each adjuster and classifier, aggregated over test and training sets. Most adjusters have consistent performance. These adjusters include Combat, Naive, and Rank Twice, which performed well for all classifiers. The figure shows that their rank compared to other adjusters was centered on third to fifth for each classifier.
