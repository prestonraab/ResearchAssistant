import { OutlineParser, SearchService } from '../index.js';
import {
  SectionCoverage,
  ManuscriptCoverage,
  SentenceCoverage,
 ...
 * 
 * Provides:
 * - Sentence-level coverage analysis
 * - Sentence classification (factual, opinion, transition, question)
 * - Coverage percentage calculation
 * - Targeted search query generation for unsupported sentences
 * 
...
export class CoverageAnalyzer {
   ...
   * 
   * Analyzes each sentence in the section and determines:
   * - Sentence type (factual, opinion, transition, question)
   * - Whether the sentence is supported by claims
   * - Matching claims for supported sentences
   * - Suggested search queries for unsupported sentences
   * 
   * @param sectionId The section ID to analyze
   * @returns Coverage analysis for the section
   */
   ...
   * 
   * Analyzes all sections in the manuscript and provides:
   * - Per-section coverage analysis
   * - Average coverage across all sections
   * - Weakest sections (lowest coverage)
   * 
   * @returns Coverage analysis for the entire manuscript
   */
   ...
   * 
   * @param sentence The unsupported sentence
