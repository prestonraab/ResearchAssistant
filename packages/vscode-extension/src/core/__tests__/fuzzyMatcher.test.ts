...
describe('FuzzyMatcher', () => {
  ...
  describe('normalizeText', () => {
    ...
    describe('line break handling', () => {
      it('should convert Unix line breaks to spaces', () => {
        const input = 'hello\nworld';
        const result = matcher.normalizeText(input);
        expect(result).toBe('hello world');
      });

      it('should convert Windows line breaks to spaces', () => {
        const input = 'hello\r\nworld';
        const result = matcher.normalizeText(input);
        expect(result).toBe('hello world');
      });

      it('should convert old Mac line breaks to spaces', () => {
    ...
    describe('Unicode normalization', () => {
      it('should normalize composed and decomposed characters to same form', () => {
    ...
    describe('hyphenation handling', () => {
      ...
      it('should normalize en dash to hyphen-minus', () => {
        // En dash is U+2013
      ...
      it('should normalize em dash to hyphen-minus', () => {
        // Em dash is U+2014
      ...
      it('should normalize Unicode hyphen to hyphen-minus', () => {
      ...
      it('should normalize minus sign to hyphen-minus', () => {
  ...
  describe('calculateSimilarity', () => {
    ...
    describe('similar strings', () => {
      ...
      it('should return high similarity for strings with OCR-like errors', () => {
        // Common OCR errors: 'l' vs '1', 'O' vs '0'
        const result = matcher.calculateSimilarity('hello', 'he11o');
        expect(result).toBeGreaterThan(0.5);
      });

      it('should return high similarity for strings with extra spaces', () => {
  ...
  describe('findMatch', () => {
    describe('exact matches', () => {
      ...
      it('should return correct offsets for exact match', () => {
    ...
    describe('fuzzy matches', () => {
      it('should find match with minor differences', () => {
        const highlight = 'hello world';
      ...
      it('should find match despite whitespace differences', () => {
        const highlight = 'hello world';
        const document = 'This is hello  world in a document.';
      ...
      it('should find match despite line break differences', () => {
        const highlight = 'hello world';
    ...
    describe('no match scenarios', () => {
      it('should return matched=false when no match above threshold', () => {
      ...
      it('should return matched=false for empty highlight', () => {
      ...
      it('should return matched=false for empty document', () => {
    ...
    describe('best match selection', () => {
      it('should select the best match when multiple candidates exist', () => {
        const highlight = 'hello world';
