...
**Primary Quote**:
> "However, most state-of-the-art domain adaptation methods were designed for largescale data such as images, whereas biological datasets are smaller and have more features, and these are also complex and heterogeneous."
...
**Primary Quote**:
> "State-of-the-art DA approaches often require tens of thousands (or even millions) of samples to train [e.g. ( 27 - 29 )], but biological datasets have a few dozens or hundreds of samples despite having thousands of features ( 31 - 33 ). DA models should be evaluated on biological-scale datasets [e.g., Office31 ( 36 )]."
